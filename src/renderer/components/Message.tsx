        ...
        {message.toolCalls && message.toolCalls.length > 0 && (
          <div className="tool-calls" style={{ marginBottom: "8px" }}>
            {message.toolCalls.map((call, index) => {
              ...
              return (
                <div key={index} className="tool-call-block" style={{
                  fontSize: "0.85em",
                  ...
                  <div style={{ color: "#444", fontFamily: "monospace", fontSize: "0.8em" }}>
                    {JSON.stringify(call.args)}
                  </div>
                  {result && (
                    <details style={{ marginTop: "4px" }}>
                      <summary style={{ cursor: "pointer", fontSize: "0.9em" }}>Result</summary>
                      <pre style={{
                        maxHeight: "200px",
                        overflow: "auto",
                        backgroundColor: "#fff",
